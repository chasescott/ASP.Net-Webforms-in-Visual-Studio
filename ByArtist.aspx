<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ByArtist.aspx.cs" Inherits="CSP1.ByArtist" %>
...
<SeparatorTemplate>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:dbcs16adlConnectionString %>" 
        SelectCommand="SELECT [Concept], [Designer], [DateofArtwork], [Id], [PDF], [Title], [AverageScore] FROM [ArtworkTestPlusRatings] WHERE ([Designer] = @Designer)">
        <SelectParameters>
            <asp:QueryStringParameter Name="Designer" QueryStringField="Tag" Type="String" />
        </SelectParameters>
        </asp:SqlDataSource>
</p>
<p>
